...
function gotoPlayerPlay(){
    document.getElementById("launchPage").style.display = 'none';
    document.getElementById("playerPlayPage").style.display = 'block';

}

function fill(dict){
	if(document.getElementById("adminPlayScreen").style.display == 'grid')
	{
		for (x in dict) {
	...
	} else if(document.getElementById('playerPlayPage').style.display = 'block'){
        var list = document.getElementById('playerField');
        for(x in dict){
            var item = document.createElement('option');
            item.innerHTML = dict[x].name;
            playerField.appendChild(item);
        }
    }
}
